...
<body>
  ...
  <nav class="top-bar">
    ...
    <ul class="title-area">
      <a href="index.html">Marcus Carter Design</a>
      <li class="name">
        <h1>
          <a href="#">
      ...
      <ul class="right">
        ...
        <li class="has-dropdown">
          ...
          <ul class="dropdown">
            ...
            <li><a href="project1.html">Lebron Fashion</a></li>
            <li><a href="project2.html">Miami Heat</a></li>
            <li><a href="project3.html">Steve Jobs Autobiography</a></li>
      ...
      <div class="row">
        <div class="large-12 hide-for-small">
          ...
          <div id="featured" data-orbit>
              <a class="slides" href="project1.html"><img src="img/lbj.png" alt="Lebron James Fashion" title="lbj"></a>
			   <a class="slides" href="project2.html"><img src="img/miami.png" alt="Miami Heat Business" title="Heat"></a>
			    <a class="slides" href="project3.html"><img src="img/steve.png" alt="Steve Jobs" title="Jobs"></a>
    ...
    <!-- Mobile Header -->
      ...
      <div class="row">
        <div class="large-12 columns show-for-small">
           ...
           <img src="img/mobile_bg.jpg" alt="Portland Sign" title="Sign">
  ...
  <div class="row">
    ...
    <!-- Footer -->
      ...
      <footer class="row">
        <div class="large-12 columns"> <div class="hr">&nbsp;</div>
            <div class="row">
